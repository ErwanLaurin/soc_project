...
namespace CacheService
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri httpUrl = new Uri("http://localhost:8090/MyService/CacheService");

            //Create ServiceHost
            ServiceHost host = new ServiceHost(typeof(CacheService), httpUrl);
            ...
            host.AddServiceEndpoint(typeof(ICacheService), new WSHttpBinding(), "");
