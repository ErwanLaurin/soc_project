...
namespace RouteService
{
    class Program
    {
        ...
        {
            Uri httpUrl = new Uri("http://localhost:8080/MyService/RouteService");

            //Create ServiceHost
            ServiceHost host = new ServiceHost(typeof(RouteService), httpUrl);
            ...
            host.AddServiceEndpoint(typeof(IRouteService), new WSHttpBinding(), "");
